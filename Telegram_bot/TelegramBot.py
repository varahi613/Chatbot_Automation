...
bot = telegram.Bot(token='7927904882:AAHQ6yQnsCs5UQXG6NELDgamXdgzyAiMnlY') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='7927904882:AAHQ6yQnsCs5UQXG6NELDgamXdgzyAiMnlY', use_context=True) #Replace TOKEN with your token string
